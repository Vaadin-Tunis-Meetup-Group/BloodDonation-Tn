...
public class CardLayout extends HorizontalLayout {
	private Component leftComponent;
	private Component rightComponent;
	private Object object;

	public CardLayout(Component leftComponent, Component rightComponent,
			Object object) {
		super();
	...
	public CardLayout(Component component, Object object) {
		super();
	...
	public CardLayout(Component component) {
		super();
		this.setLeftComponent(component);
		addComponent(this.leftComponent);
		setWidth("100%");
